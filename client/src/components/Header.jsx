  ...
  return (
    <div className='flex items-center justify-between max-sm:flex-col-reverse gap-y-10 px-4 mt-10 lg:px-44 sm:mt-20'>
        ...
        <div>
            ...
            <p className='sm:w-[90%] my-6 text-[15px] text-gray-500'><strong>CleanSlate Studio</strong> is a powerful and user-friendly background removal app designed to make your images stand out. With advanced AI tools, it effortlessly removes unwanted backgrounds, leaving you with crisp, professional-quality visuals.</p>
