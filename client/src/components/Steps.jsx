        ...
        <div className='flex items-start flex-wrap gap-4 mt-16 xl:mt-24 justify-center'>
            ...
            <div className='flex items-start gap-4 bg-white border drop-shadow-md p-7 pb-10 rounded hover:scale-105 transition-all duration-500'>
                ...
                <div>
                    ...
                    <p className='text-sm text-neutral-500 mt-1'>Select and upload an image from your <br /> device to edit.</p>
                </div>
            </div>
            ...
            <div className='flex items-start gap-4 bg-white border drop-shadow-md p-7 pb-10 rounded hover:scale-105 transition-all duration-500'>
                ...
                <div>
                    ...
                    <p className='text-sm text-neutral-500 mt-1'>Effortlessly remove image backgrounds <br /> for a clean, sharp look.</p>
                </div>
            </div>
            ...
            <div className='flex items-start gap-4 bg-white border drop-shadow-md p-7 pb-10 rounded hover:scale-105 transition-all duration-500'>
                ...
                <div>
                    ...
                    <p className='text-sm text-neutral-500 mt-1'>Save your edited image instantly with <br /> one click.</p>
                </div>
            </div>
